...
for record in data: 
    ...
    if project_name == 'flipside':
        pic = "https://cdn-images-1.medium.com/max/1200/1*jyjwobJLOxKXIurGpC7myA.png"
    else:
        pic = pics[project_name]

    time.sleep(1)
    # Set the payload (i.e. the body of the tweet)
    print(f"{label} {vote} on proposal {proposal_id} with the following rational: {memo}.\n{link_prop}")
    print(pic)
